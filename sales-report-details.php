        ...
        <div class="hk-pg-wrapper">
            <nav class="hk-breadcrumb" aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-light bg-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Отчет прибыли</li>
                </ol>
            </nav>
            <div class="container">
...
?>
    ...
    <span class="feather-icon"><i data-feather="database"></i></span></span>Отчет прибыли с <?php echo $fdate ?>
                                ...
                                <div class="col-sm">
                                    <div class="table-wrap">
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                            ...
                                            $query = mysqli_query($con, "select sum(tblorders.Quantity) as q, month(tblorders.InvoiceGenDate) as mnth,year(tblorders.InvoiceGenDate) as yearr, sum(tblorders.Quantity*tblproducts.ProductPrice) as tt  from tblorders join tblproducts on tblproducts.id=tblorders.ProductId  where date(tblorders.InvoiceGenDate) between '$fdate' and '$tdate' group by mnth,yearr");
                                            $cnt = 1;
