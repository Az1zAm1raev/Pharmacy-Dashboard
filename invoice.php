    ...
    <div class="hk-pg-wrapper">
        <nav class="hk-breadcrumb" aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-light bg-transparent">
                <li class="breadcrumb-item"><a href="#">Квитанция</a></li>
                <li class="breadcrumb-item active" aria-current="page">Просмотр</li>
            </ol>
        </nav>
        <div class="container">
            <div class="hk-pg-header">
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="file"></i></span></span>Просмотр квитанции</h4>
            </div>
            <div class="row">
                <div class="col-xl-12">
                        ...
                        <div class="row">
                            ...
                            {?>
                                <div class="col-md-5 mb-20">
                                    <h4 class="mb-35 font-weight-600">Квитанция</h4>
                                    <span class="d-block">Дата:<span class="pl-10 text-dark"><?php echo $row['InvoiceGenDate'];?></span></span>
                                    <span class="d-block">Квитанция:<span class="pl-10 text-dark"><?php echo $row['InvoiceNumber'];?></span></span>
                                    <span class="d-block">Имя:<span class="pl-10 text-dark"><?php echo $row['CustomerName'];?></span></span>
                                    <span class="d-block">Телефон:<span class="pl-10 text-dark"><?php echo $row['CustomerContactNo'];?></span></span>
                                    <span class="d-block">Метод оплаты:<span class="pl-10 text-dark"><?php echo $row['PaymentMode'];?></span></span>
                                </div>
                            <?php } ?>
                            ...
                            <div class="col-sm">
                                <div class="table-wrap">
                                    <table class="table mb-0" border="1">
                                        ...
                                        ?>
                                        <tr>
                                            <th colspan="6" style="text-align:center; font-size:20px;">Итог</th>
