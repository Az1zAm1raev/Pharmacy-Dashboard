<nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar">
    ...
    <a class="navbar-brand" href="dashboard.php">Диплом
    </a>
        ...
        <li class="nav-item dropdown dropdown-authentication">
            ...
            <div class="dropdown-menu dropdown-menu-right" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                <a class="dropdown-item" href="profile.php"><i
                            class="dropdown-icon zmdi zmdi-account"></i><span>Профиль</span></a>
                <a class="dropdown-item" href="change-password.php"><i
                            class="dropdown-icon zmdi zmdi-settings"></i><span>Настройки</span></a>
                <a class="dropdown-item" href="logout.php"><i
                            class="dropdown-icon zmdi zmdi-power"></i><span>Выход</span></a>
            </div>
        </li>
    </ul>
</nav>