...
if($query){
echo "<script>alert('Изменено');</script>";
...
<li class="breadcrumb-item active" aria-current="page">Админ</li>
            ...
            <div class="container">
                <div class="hk-pg-header">
                    <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Изменить профиль</h4>
                </div>
...
<label for="validationCustom03">Дата регистрации</label>
...
<div class="form-row">
<div class="col-md-6 mb-10">
<label for="validationCustom03">Последнее обновление</label>
...
<div class="form-row">
<div class="col-md-6 mb-10">
<label for="validationCustom03">Логин</label>
...
<div class="form-row">
<div class="col-md-6 mb-10">
<label for="validationCustom03">Почта</label>
...
<button class="btn btn-primary" type="submit" name="update">Обновить</button>
</form>
</div>
</div>
</section>
